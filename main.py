...
def parse_args(args=None):
    ...
    parser.add_argument('--data_path', type=str, default="data/API/lowOrder/noNeg/2", help="KG data path")
    ...
    parser.add_argument('--max_steps', default=10000, type=int, help="maximum iterations to train")
